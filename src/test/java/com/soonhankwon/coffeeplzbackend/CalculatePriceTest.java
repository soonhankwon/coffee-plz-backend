...
public class CalculatePriceTest {
    ...
    void calculatePriceTest() {
        OrderRequestDto orderRequestDto1 = new OrderRequestDto(OrderItem.ItemSize.S, 3000L);
        OrderRequestDto orderRequestDto2 = new OrderRequestDto(OrderItem.ItemSize.M, 3000L);
        OrderRequestDto orderRequestDto3 = new OrderRequestDto(OrderItem.ItemSize.L, 3000L);
